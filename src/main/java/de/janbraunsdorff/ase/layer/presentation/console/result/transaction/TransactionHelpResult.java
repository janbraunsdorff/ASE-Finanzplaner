...
public class TransactionHelpResult implements Result {
    ...
    public String print() {
        return new HelpOutputBuilder(130)
                ...
                .addCommand("transaction all -i [Account ID]        {-l [Anzahl an Transactionen]}", "Zeigt die letzten Transactionen an. Anzahl ist optional")
                ...
                .addCommand("transaction add -i [Account ID]        -val [Betrag in Cent] -thp [Von / Nach] {-dat [DD.MM.YY]} {-cat [Kategorie]} {-con}", "Legt eine neue Transaction an. Datum, Kategorie und Vertrag sind optional")
